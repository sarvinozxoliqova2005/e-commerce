...
<button className="bg-orange-500 text-white rounded-lg px-6 py-2 flex items-center justify-center gap-2">
  ...
  <div className="py-[60px]">
    <div className="space-y-10">
       {categories.map((el) => (
        <div key={el.id}>
          <h1 className="text-2xl font-bold text-orange-500 mb-4 px-4 max-w-[1200px] mx-auto max-[600px]:pl-9">{el.title}</h1>

         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 px-4 max-w-[1200px] mx-auto max-[600px]:max-w-[350px]">
